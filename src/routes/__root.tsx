...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Crystal Love International" },
      ...
      { name: "twitter:title", content: "Crystal Love International — Freshness in Every Spoonful" },
      { name: "twitter:description", content: "Premium Greek yoghurt parfaits with fresh fruits, crunchy granola and wholesome ingredients. Order Crystal Exotic Parfaits in Lagos, Nigeria." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/f43aa6a7-bcb9-4945-b29a-cbddddc5e591" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/f43aa6a7-bcb9-4945-b29a-cbddddc5e591" },
    ],
    links: [

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Crystal Love International — Home of Crystal Exotic Parfaits" },
      { name: "description", content: "Freshness in every spoonful. Premium Greek yoghurt parfaits made with fresh fruits, crunchy granola and wholesome ingredients. Order in Lagos, Nigeria." },
